...
const Navbar = () => {
    ...
    const navLink = <div className="flex justify-center items-center gap-10 text-[#000000]">
    <NavLink to='/' className={({ isActive }) =>
          isActive
            ? "  font-roboto  font-semibold px-2 py-1 rounded bg-blue-200"
  ...
  <div className="navbar-start">
    ...
    <img src={logo} alt="" />
    <a className=" font-roboto  font-semibold  text-2xl drop-shadow-lg text-[#000000]">MediLab Hospital</a>
  </div>
  ...
  <div className="navbar-end flex justify-center items-center gap-5">
    ...
    <a className=" font-roboto text-white  font-semibold shadow-lg bg-[#9083D5] px-5 py-3 rounded-2xl">Regester</a>
  </div>
</div>
    );
};
